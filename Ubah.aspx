<%@ Page Title="Ubah" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ubah.aspx.cs" Inherits="PBO_Imanuel.Ubah" %>
    ...
    <div class="container">
        <div class="row cardd rounded p-4 ">
            ...
            <div class="col-8 mb-3">
                ...
                <asp:Button class="btn table-bg text-white" Text="Simpan" OnClick="updateData" runat="server" />
